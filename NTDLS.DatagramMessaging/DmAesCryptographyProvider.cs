...
namespace NTDLS.DatagramMessaging
{
    ...
    /// </summary>
    /// <remarks>This class implements the <see cref="IDmCryptographyProvider"/> interface to provide
    ...
    /// operation.</remarks>
    public class DmAesCryptographyProvider : IDmCryptographyProvider
    {
        ...
        public DmAesCryptographyProvider(byte[] aesKey)
        {
            if (aesKey == null)
        ...
        /// <summary>
        /// Initializes a new instance of the DmAesCryptographyProvider class using a password and a specified AES key
        /// size.
        /// </summary>
        ...
        public DmAesCryptographyProvider(string password, DmAesKeySize aesKeySize = DmAesKeySize.Aes128)
        ...
        private static byte[] DeriveKey(string password, DmAesKeySize aesKeySize = DmAesKeySize.Aes128)
        {
        ...
        /// <summary>
        /// Decrypts the specified encrypted byte array using the provided <see cref="DmContext"/>.
        /// </summary>
        ...
        /// formatted.</remarks>
        /// <param name="context">The <see cref="DmContext"/> instance that provides the necessary context for decryption.  This parameter is
        ...
        public byte[] Decrypt(DmContext context, byte[] encryptedBytes)
        {
        ...
        /// <param name="context">The <see cref="DmContext"/> instance providing the encryption context. This parameter is reserved for future
        ...
        public byte[] Encrypt(DmContext context, byte[] plaintextBytes)
        {
            using var aes = Aes.Create();
            aes.Key = _aesKey;
            aes.Mode = CipherMode.CBC;
